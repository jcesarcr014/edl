...
// Cargamos los datos
Nomina12::CargarDatosCfdi33Timbrado($electronicDocument);
...
if ($result == ProcessProviderResult::OK) {
    ...
    Html::showXml('CFDI 3.3 - RECIBO DE NÓMINA 1.2', $xml, Descripcion::get(Descripcion::ECODEX_RECIBO_NOMINA_CFDI_33));
